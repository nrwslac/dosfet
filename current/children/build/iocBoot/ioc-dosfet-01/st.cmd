...
epicsEnvSet( "IOCNAME",	  "ioc-dosfet-01" )
epicsEnvSet( "ENGINEER",  "Nicholas Waters (AD PORT)" )
epicsEnvSet( "LOCATION",  "901-113" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:DOSFET:01" )
...
##############################################################
drvAsynIPPortConfigure( "bus0", "tst-radfet-113:10001", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/dosfet.db", "P=DOSFET:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-dosfet-01.sav" )
...
create_monitor_set( "ioc-dosfet-01.req", 5, "" )
