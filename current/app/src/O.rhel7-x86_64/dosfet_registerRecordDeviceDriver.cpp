...
/* Generated from ../O.Common/dosfet.dbd */
...
int dosfet_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/reg/g/pcds/epics-dev/nrw/iocs/dosfet/current";
...
/* dosfet_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"dosfet_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(dosfet_registerRecordDeviceDriver(*iocshPpdbbase));
}
